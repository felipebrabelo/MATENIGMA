...
int seleciona() {
    ...
    while (fread(&teste, sizeof(player), 1, fp) > 0 && zerado < 10) {
        list[zerado].score = teste.score;
        strcpy(list[zerado].name, teste.name);
    ...
    for (i = 0; i < 10 && list[i].score > 0; i++) {
        fwrite(&list[i], sizeof(player), 1, fp);
    }
...
void DrawNameScreen(void)
{
    ...
    DrawText(TextFormat("rank   nome                  pontos \n"), screenWidth / 2 - 500, screenHeight / 2 + 100, 25, GRAY);
        ...
        DrawText(TextFormat("-!-!-_!-!%s\n",list[5].name), screenWidth / 2 - 300, screenHeight / 2 + 50, 40, BLACK);
        DrawText(TextFormat("---%s\n", list[0].name), screenWidth / 2 - 300, screenHeight / 2 + 80, 15, BLACK);
        DrawText(TextFormat("---%s\n", list[1].name), screenWidth / 2 - 300, screenHeight / 2 + 100, 15, BLACK);
        DrawText(TextFormat("---%s\n", list[2].name), screenWidth / 2 - 300, screenHeight / 2 + 120, 15, BLACK);
        DrawText(TextFormat("---%s\n", list[3].name), screenWidth / 2 - 300, screenHeight / 2 + 140, 15, BLACK);
        DrawText(TextFormat("---%s\n", list[4].name), screenWidth / 2 - 300, screenHeight / 2 + 160, 15, BLACK);


        DrawText(TextFormat("---%lf\n", list[5].score), screenWidth / 2 - 300, screenHeight / 2 + 80, 15, BLACK);
